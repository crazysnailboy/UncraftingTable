...
public class VersionCheckerTask implements Runnable
{
    ...
    public void run() 
    {
        ...
        try 
        {
            ...
            // get the update log for the latest and recommended versions of the mod for this minecraft version
//          JsonObject versionObject = jobject.getAsJsonObject(cpw.mods.fml.common.Loader.MC_VERSION);
//        	String latestVersionDesc = versionObject.get(latestVersion).getAsString();
//        	String recommendedVersionDesc = versionObject.get(recommendedVersion).getAsString();
