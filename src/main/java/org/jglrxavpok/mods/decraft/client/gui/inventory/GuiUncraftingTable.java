...
public class GuiUncraftingTable extends GuiContainer
{
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        itemRender.renderItemIntoGUI(this.fontRendererObj, this.mc.renderEngine, new ItemStack(Items.book), guiX + slotX, guiY + slotY);
    ...
    private class GuiButton extends net.minecraft.client.gui.GuiButton
    {
		...
		public void drawButton(Minecraft mc, int mouseX, int mouseY)
		{
			if (this.visible)
			{
				...
				mc.getTextureManager().bindTexture(uncraftingTableGuiTextures);
