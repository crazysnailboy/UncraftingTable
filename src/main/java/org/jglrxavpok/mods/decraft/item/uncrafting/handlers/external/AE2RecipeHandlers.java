...
public class AE2RecipeHandlers
{
	...
	public static class ShapedAE2RecipeHandler extends RecipeHandler
	{
		...
		private List<List<ItemStack>> getIngredients(IRecipe r)
		{
			try
			{
				// *** adapted from appeng.integration.modules.NEIHelpers.NEIAEShapedRecipeHandler.CachedShapedRecipe ***
		...
		private static ItemStack[] reshapeRecipe(List<ItemStack> recipeItems, IRecipe r)
		{
			...
			catch(Exception ex) { ModUncrafting.instance.getLogger().catching(ex); return recipeItems.toArray(new ItemStack[9]); }
		}
	...
	public static class ShapelessAE2RecipeHandler extends RecipeHandler
	{
		...
		private List<List<ItemStack>> getIngredients(IRecipe r)
		{
			try
			{
				...
				// *** adapted from appeng.integration.modules.NEIHelpers.NEIAEShapelessRecipeHandler.CachedShapelessRecipe ***
