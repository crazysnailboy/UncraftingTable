...
public class UncraftingResult
{
	...
	public List<Map.Entry<ItemStack[],Integer>> craftingGrids;
	...
	public UncraftingResult()
	{
		...
		this.craftingGrids = new ArrayList<Map.Entry<ItemStack[],Integer>>();
...
//	}
	...
	{
		return (craftingGrids.size() > 0 ? craftingGrids.get(selectedCraftingGrid).getKey() : null);
	}
